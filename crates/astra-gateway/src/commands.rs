...
fn model_entries() -> Vec<ModelEntry> {
    vec![
        ...
        // TAAS (via Codex CLI) — @taas/ prefix ensures unique full_id
        ModelEntry {
            label: "DeepSeek V4 Pro (TAAS)".into(),
            desc: "最强 / 代码 · TAAS".into(),
            full_id: Some("@taas/deepseek-v4-pro".into()),
        ...
        ModelEntry {
            ...
            full_id: Some("@taas/kimi-k2.6".into()),
            provider: Some("taas".into()),
        ...
        ModelEntry {
            ...
            desc: "智谱 · TAAS".into(),
            full_id: Some("@taas/glm-5.1".into()),
            provider: Some("taas".into()),
        ...
        ModelEntry {
            ...
            full_id: Some("@taas/qwen3.6-plus".into()),
            provider: Some("taas".into()),
        ...
        ModelEntry {
            ...
            desc: "快 / 省 · TAAS".into(),
            full_id: Some("@taas/qwen3.6-flash".into()),
            provider: Some("taas".into()),
            aliases: vec![],
        },
        ModelEntry {
            ...
            full_id: Some("@taas/claude-opus-4-7".into()),
            provider: Some("taas".into()),
            aliases: vec![],
        },
        ModelEntry {
            ...
            desc: "日常任务 · TAAS".into(),
            full_id: Some("@taas/claude-sonnet-4-6".into()),
            provider: Some("taas".into()),
            aliases: vec![],
        },
    ]
